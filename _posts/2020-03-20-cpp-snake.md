...
This project started with the idea of practicing and reminding myself coding in C++. It is helpful for remembering some basic information of C++ classes, structures and data structures in this language. The code is based on the implementation made by ThePoorEngineer [here](https://www.thepoorengineer.com/en/snake-cplusplus/)
